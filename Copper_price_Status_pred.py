...
st.set_page_config(page_title='Industrial copper',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by AJAY K'})
...
if selected == "About":
    ...
    st.markdown('##### Linkedin: https://www.linkedin.com/in/ajay-k-76a28a227/')
    st.markdown('##### GitHub : https://github.com/AjayKarthekeyan/Copper_Modeling') 
